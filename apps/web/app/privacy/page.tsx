  ...
  return (
    <div className="mx-auto w-full max-w-3xl px-4 py-8">
      ...
      <p className="mb-8 rounded-md border border-dashed p-3 text-sm text-muted-foreground">
        This describes what MarketitNow actually collects and does today, in plain language. It draws on GDPR and common
      ...
      <div className="flex flex-col gap-8 text-sm text-muted-foreground">
        <section>
          ...
          <p>
            MarketitNow is operated by Atlantean Globals Services, a company registered in the Netherlands under KVK number
            89423496 (&quot;MarketitNow&quot;, &quot;we&quot;, &quot;us&quot;). We are the data controller for the personal
        ...
        <section>
          ...
          <ul className="flex flex-col gap-1.5 pl-1">
            {[
              ...
              "Messages you send to other users through MarketitNow, and reviews you leave or receive.",
        ...
        <section>
          ...
          <p>
            ...
            how MarketitNow is used, are only set if you accept them in the cookie banner shown on your first visit; choosing
        ...
        <section>
          ...
          <p>
            We share data only with the providers that run MarketitNow on our behalf, and only what each one needs to do its
        ...
        <section>
          ...
          <p>MarketitNow is not directed at children, and you must be at least 18 (or the age of majority where you live) to create an account.</p>
        </section>

        <section>
          <h2 className="mb-2 text-base font-semibold text-foreground">9. Changes to this policy</h2>
          <p>We may update this policy as MarketitNow grows or legal requirements change. We&apos;ll update the date at the top of this page when we do.</p>
        </section>
